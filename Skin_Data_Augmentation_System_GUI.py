...
class Ui_MainWindow(object):
    ...
    def LoadTrainedModel(self):
        ...
        model_name = self.textEdit.toPlainText()
        if len(model_name) != 0:
        ...
        if self.sess == None or self.G_sample == None or self.saver == None:
            ...
            if len(self.lineEdit_2.text()) != 3 or len(self.lineEdit_3.text()) == 0 or len(
                ...
                if os.path.isfile(
                    ...
                    generate_new_user_data(self.sess, self.G_sample, start_file_name_No, n_sample, window_size, Age,
                                           date_year,
                                           date_month,
                                           date_day)
        ...
        if self.sess == None or self.G_sample == None or self.saver == None:
            ...
            if len(self.lineEdit_9.text()) == 0 or len(self.lineEdit_12.text()) != 4 or len(
                ...
                if os.path.isfile(
                    ...
                    generate_existing_user_data(self.sess, self.G_sample, self.ExistUser_File, window_size, date_year,
                                                date_month,
                                                date_day)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label.setText(_translate("MainWindow", "Skin Data Augmentation System"))
